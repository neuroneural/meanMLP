...
Check out the 👉 [**Colab tutorial**](https://colab.research.google.com/github/neuroneural/meanMLP/blob/ml4fmri/scripts/ml4fmri_tutorial.ipynb) for a more detailed guide and ways to modify the default behavior.
